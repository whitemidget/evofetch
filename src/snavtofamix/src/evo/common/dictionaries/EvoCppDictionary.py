...
from common.dictionaries.CppDictionary import CppDictionary

from evo.common.dictionaries.RestrictedByFile import RestrictedByFile

class EvoCppDictionary(CppDictionary, RestrictedByFile):
    def __init__(self, fileDict):
        CppDictionary.__init__(self)
        RestrictedByFile.__init__(self, fileDict)
        
    def add(self, block, sourceFile, start, end):
        if self.isFilePermitted(sourceFile):
            CppDictionary.add(self, block, sourceFile, start, end)
