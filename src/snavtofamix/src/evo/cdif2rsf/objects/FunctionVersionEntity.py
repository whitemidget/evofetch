...
class FunctionVersionEntity:
    def __init__(self):
        self.identifier = None
        self.uniqueName = None
        self.functionIdentifier = None
    ...
    def getFunctionIdentifier(self):
        return self.functionIdentifier
    
    def setFunctionIdentifier(self, functionIdentifier):
